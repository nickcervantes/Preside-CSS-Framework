    				...
    				<div class="col-xs-12 col-md-8">
                        ...
                        <div class="toggle-tabs mod-mobile-accordion mod-tab-links">
                            ...
                            <div class="toggle-tabs-nav">
                                ...
                                <ul>
                                    <li><a href="/pages/test-pages/tab-page-1.cfm" role="tab" >Tab Page 1</a></li>
                                    <li class="is-active"><a href="/pages/test-pages/tab-page-2.cfm" role="tab" >Tab Page 2</a></li>
                            ...
                            <div class="toggle-tabs-panel">
                                ...
                                <div class="toggle-tabs-panel-item">
                                    ...
                                    <a href="#" class="toggle-tabs-panel-item-header">Tab Page 2</a>

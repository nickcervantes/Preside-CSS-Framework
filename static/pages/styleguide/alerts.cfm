		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xs-12">
					...
					<h3 class="style-heading" id="page-tools">Page tools</h3>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-8">
					...
					<h3 class="style-heading" id="toggle-widget">Toggle widget</h3>
					...
					<div class="guide-block">
						...
						<p class="style-caption">Collapsible widget <code>.collapsible</code></p><br/>
						...
						<p class="style-caption">Accordion widget <code>.collapsible.accordion</code></p><br/>
						...
						<p class="style-caption">Nested collapsibles (commonly used in FAQs)</p>

					</div>

					<h3 class="style-heading" id="tabs">Tabs</h3>

					<div class="guide-block">

						<p class="style-caption">Tabs <code>.toggle-tabs</code></p>
						...
						<p class="style-caption">Tabs turning to accordion in mobile <code>.toggle-tabs.mod-mobile-accordion</code></p>
						...
						<p class="style-caption">Compact tabs - add <code>.mod-float-left</code> to <code>.toggle-tabs-nav</code></p>

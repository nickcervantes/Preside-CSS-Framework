...
function helperHandler() {
	...
	helper = {
		...
		, addDebounceResize: function( funct ) {
			var _afterResized = helper.afterResized;
			helper.afterResized = function() {
				_afterResized();
				funct();
			}
	...
	// Setup resize debounce function
	var afterResize  = 0;
	$( window ).on( "resize", function() {
		clearTimeout( afterResize );
		afterResize = setTimeout( helper.afterResized, 250 );
	} );
...
function collapsibleHandler( $container ) {
...
// Toggle tabs
function toggleTabsHandler( $container ) {
	...
	helper.addDebounceResize( function() {
...
function subnavigationWidgetHandler() {
